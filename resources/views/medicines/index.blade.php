                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuReference22">
                                                    <a class="dropdown-item" href="/medicines/{{$item->id}}/edit"><i class="fa fa-pen"></i> {{__('lang.edit')}}</a>
                                                  
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item " href="/medicines/{{$item->id}}/delete"><i class="fas fa-trash"></i> {{__('lang.delete')}}</a>
                                                </div>
                                            </div>                                            
                                        </td>
                                    </tr>
