...
<div class="layout-px-spacing">
            ...
            <div class="statbox widget box box-shadow create-widget">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>{{__('lang.create')}} {{__('lang.medicines')}}</h4>
                            @if($errors->any())
                ...
                <div class="widget-content widget-content-area">
                    <form action="/medicines/create" method="post" enctype='multipart/form-data'>
                        {{csrf_field()}}
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="instructions"  type="text" class="form-control" id="inputEmail4" placeholder="{{__('lang.instructions')}}">
                            </div>  
