...
<div class="layout-px-spacing">
            ...
            <div class="statbox widget box box-shadow create-widget">
                ...
                <div class="widget-content widget-content-area">
                    <form action="/medicines/update" method="post" enctype='multipart/form-data'>
                        {{csrf_field()}}
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input value="{{$item->instructions}}" name="instructions" type="text" class="form-control" id="inputEmail4" placeholder="{{__('lang.name')}}">
                            </div> 
