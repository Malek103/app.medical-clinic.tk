...
<div class="layout-px-spacing">
            ...
            <div class="statbox widget box box-shadow create-widget">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>{{__('lang.edit')}} {{$category->name}}</h4>
                            @if($errors->any())
                ...
                <div class="widget-content widget-content-area">
                    <form action="/examinations/category/update/{{ $category->id }}" method="post" enctype='multipart/form-data'>
                        {{csrf_field()}}
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">{{__('lang.name')}}</label>
                                <input name="name" value="{{$category->name}}" required type="text" class="form-control" id="inputEmail4" placeholder="{{__('lang.name')}}">
                            </div>
