...
<div class="layout-px-spacing">
            ...
            <div class="statbox widget box box-shadow create-widget">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>{{__('lang.create')}} {{__('lang.medical_examinations')}}</h4>
                            @if($errors->any())
                ...
                <div class="widget-content widget-content-area">
                    <form action="/examinations/create" method="post" enctype='multipart/form-data'>
                        {{csrf_field()}}
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">{{__('lang.category')}}</label>
