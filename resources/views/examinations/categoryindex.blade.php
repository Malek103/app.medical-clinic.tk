                            ...
                            <div class="widget-header">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-md-3 col-sm-6 col-6"  >
                                        <a type="button" class="btn btn-outline-info" href="/examinations/category/create" style="float: left;margin-left: 30px;padding:5px 60px">{{__('lang.add')}}</a>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuReference22">
                                                    <a class="dropdown-item" href="/examinations/category/edit/{{ $category->id }}"><i class="fa fa-pen"></i> {{__('lang.edit')}}</a>
