                    ...
                    <form action="/myaccount" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input name="name" value="{{auth()->user()->name}}" required type="text" class="form-control" id="inputEmail4" placeholder="{{__('lang.name')}}">
                            </div>                            
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">{{__('lang.email')}}</label>
                                <input name="email" value="{{auth()->user()->email}}" required type="email" class="form-control" id="inputEmail4" placeholder="{{__('lang.email')}}">
                            </div>


                            <div class="form-group col-md-6">
                                <label for="inputEmail4">{{__('lang.phone')}}</label>
                                <input name="phone" value="{{auth()->user()->phone}}"  type="text" class="form-control" id="inputEmail4" placeholder="{{__('lang.phone')}}">
                            </div>                            
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">{{__('lang.birthdate')}}</label>
                                <input name="birthdate" value="{{auth()->user()->birthdate}}" type="date" class="form-control" id="inputEmail4">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <img class="preview-image" src="/uploads/{{auth()->user()->image}}"  />
